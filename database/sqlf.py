...
def add_one(table: str, data: tuple):

    # Input: table = name of the table
    #         data = tuple of every value for the record
    ...
    vals = columns(len(data))

    # Add one record at a time
    c.execute("INSERT INTO " + table + " VALUES " + vals, data)
...
def create_table(table: str, data: str):
    ...
    # Create a Table
    c.execute("CREATE TABLE " + table + data)
